...
extension UIColor{
    ...
    ///短分隔線
    static var shortSeparatorColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.9)
    /// press底色
    static var pressColor = #colorLiteral(red: 0.1333333333, green: 0.1333333333, blue: 0.1333333333, alpha: 0.95)
    ///警示文字
